...
mixin _$MyUser {
  ...
  set posts(List<dynamic> value) => throw _privateConstructorUsedError;
  List<dynamic> get favorites => throw _privateConstructorUsedError;
  set favorites(List<dynamic> value) => throw _privateConstructorUsedError;
  ...
  set following(List<dynamic> value) => throw _privateConstructorUsedError;
  List<dynamic> get followers => throw _privateConstructorUsedError;
  set followers(List<dynamic> value) => throw _privateConstructorUsedError;
...
abstract class _MyUser implements MyUser {
  factory _MyUser(
      ...
      List<dynamic> comments,
      List<dynamic> following,
      List<dynamic> followers}) = _$_MyUser;
