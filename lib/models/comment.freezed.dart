...
abstract class $CommentCopyWith<$Res> {
  ...
  $Res call({MyUser user, DateTime time, String content});
...
class _$_Comment implements _Comment {
  _$_Comment({required this.user, required this.time, required this.content});
  ...
  @override
  String toString() {
    return 'Comment(user: $user, time: $time, content: $content)';
  }
